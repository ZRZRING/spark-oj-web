...
import type {judgeSetReq} from '@/stores/submission_type.ts';
import {getJudgeSet} from '@/stores/submission_store.ts'
            ...
            <el-table style="width: 100%">
                ...
                <el-table-column prop="problem_name" label="评测结果" width="180">
                    ...
                    <template slot-scope="scope">
                        <el-tag :type="judgeResultMap[scope.row.result].type">
                            {{ judgeResultMap[scope.row.result].lable }}
                        </el-tag>
                    </template>
                </el-table-column>
